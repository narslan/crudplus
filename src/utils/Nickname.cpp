...
const char* const Nickname::ADJECTIVES[] = {
    ...
    "Ashy",       "Black",       "Blue",      "Gray",        "Green",     "Icy",        "Lemon",
    "Mango",      "Orange",      "Purple",    "Red",         "Salmon",    "White",      "Yellow",
    "Aggressive", "Agreeable",   "Ambitious", "Brave",       "Calm",      "Delightful", "Eager",
    "Faithful",   "Gentle",      "Happy",     "Jolly",       "Kind",      "Lively",     "Nice",
    "Obedient",   "Polite",      "Proud",     "Silly",       "Thankful",  "Victorious", "Witty",
    "Wonderful",  "Zealous",     "Broad",     "Chubby",      "Crooked",   "Curved",     "Deep",
    "Flat",       "High",        "Hollow",    "Low",         "Narrow",    "Refined",    "Round",
    "Shallow",    "Skinny",      "Square",    "Steep",       "Straight",  "Wide",       "Big",
    "Colossal",   "Fat",         "Gigantic",  "Great",       "Huge",      "Immense",    "Large",
...
const char* Nickname::NOUNS[] = {
    ...
    "Life",   "Lot",  "Man",      "Money",      "Month", "Mother",  "Mr",      "Night",
    "Number", "Part", "People",   "Place",      "Point", "Problem", "Program", "Question",
    "Right",  "Room", "School",   "State",      "Story", "Student", "Study",   "System",
    "Thing",  "Time", "Water",    "Way",        "Week",  "Woman",   "Word",    "Work",
    "World",  "Year"};
